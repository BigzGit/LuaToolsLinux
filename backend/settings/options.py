    ...
    SettingGroup(
        ...
        options=[
            ...
            SettingOption(
                ...
                label="Donate Keys",
                option_type="toggle",
                description="Send Steam depot decryption keys extracted from config.vdf to the configured donation server. Disabled by default; requires explicit consent and an HTTPS endpoint.",
                default=False,
